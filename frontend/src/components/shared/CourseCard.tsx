  ...
  return (
    ...
    >
      ...
      <div className="card-body p-4"> 
        <h2 className="card-title text-xl font-semibold text-base-content line-clamp-2 h-13">{course.name}</h2>
        <p className="text-xs text-base-content line-clamp-2 mt-2 overflow-hidden">{course.description}</p> 
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <div>
            <span className="text-xs text-base-content">مدرس: {course.creator?.name}</span>
          </div>
        </div>
      </div>
    </motion.div>
